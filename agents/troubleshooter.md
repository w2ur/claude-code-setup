...
**Context**: [escalation — what failed and how many attempts]
**Problem**: [root cause diagnosis, not symptoms]
**Generalization pattern**: [under-generalized / over-generalized / neither]
