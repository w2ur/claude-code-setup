...
- **Homebrew's `python@3.14` stays installed.** It is a dependency of five formulae, not a development interpreter. Do not try to remove it and do not file it as a finding.
